...
printf "Looking for javac... "
if [ ! -f /usr/bin/javac ] ; then
    printf "... not found. Installing packages... "
...
# install WebObjects
printf "Installing WebObjects (root access required)... "
...
# wobuild.properties
printf "Creating wobuild.properties... "
